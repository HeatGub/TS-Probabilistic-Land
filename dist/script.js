...
window.addEventListener('load', function () {
    ...
    class Leaf {
        ...
        parentBranch, x0, y0, len, angle, x0LeafShadow, y0LeafShadow, lineWidth = leafLineWidth, xF = 0, yF = 0, maxStages = leafMaxStageGlobal - 1, currentStage = 0, growthStages = [], canvas = canvasContainer.appendChild(document.createElement("canvas")), // create canvas
