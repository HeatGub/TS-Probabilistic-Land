...
window.addEventListener('load', function () {
    ...
    class Leaf {
        ...
        x0, y0, len, angle, lineWidth = 4, xF = 0, //could be ? but then lineTo errors with null
        ...
        calcBezierPointsForPerpendicularAxis(axisLenRatio, axisWidthRatio, moveAxis) {
