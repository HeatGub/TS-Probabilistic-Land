...
window.addEventListener('load', function () {
    ...
    class Branch {
        ...
        makeChildBranch(parent, angleDiff) {
            ...
            let childBranch = new Branch(this.xF, this.yF, this.len * 0.85, angleDiff, this.lineWidth * 0.5, parent);
    ...
    class Tree {
        constructor(initX, initY, initLen, initAngle, maxLevel = 8, trunk = new Branch(initX, initY, initLen, initAngle, 20, root), // root as a parent
        everyLevelBranches = [[]]) {
            this.initX = initX;
            this.initY = initY;
